...
<TABLE border="0" cellpadding="5" cellspacing="0" class="tabelaAction">
	<TBODY>
		<TR>
			...
			Instrumentos Musicais</TD>
		</TR>
		<TR valign="top">
			<TD width="431" height="112">
...
<TABLE>
	<TR>
		<TD align="right" width="159" height="49">
			<A href="javascript:voltaPrincipal(document.frm1);" class="cbutton">VOLTAR</A>
		</TD>
		<TD class="boxTexto" align="center" width="271" height="49">
...
<script type="text/javascript">
  ...
  _gaq.push(['_trackPageview','/APP/CotacaoMulti/Div7104Cad.jsp']);
