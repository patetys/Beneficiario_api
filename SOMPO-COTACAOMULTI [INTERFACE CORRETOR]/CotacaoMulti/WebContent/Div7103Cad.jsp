...
<TABLE border="0" cellpadding="5" cellspacing="0" class="tabelaAction">
	<TBODY>
		<TR>
			<TD class="boxTitulo" width="431">Ramo 710 - Riscos Diversos - Móveis</TD>
		</TR>
		<TR valign="top">
			<TD width="431" height="117">
				...
				<TBODY>
					...
					<TR>
						<TD class="boxTexto" height="18" colspan="2"><TEXTAREA onkeyup="javascript:maxCaracteres(document.frm1.DscEquip,495)"
							...
							style="color: #4686BE"><c:if test='${bean.dscEquip!=null}'>
							<c:out value='${bean.dscEquip}' />
						</c:if></TEXTAREA></TD>
						<TD class="boxTexto" height="22" width="1"></TD>
					</TR>
					<TR>
...
<TABLE>
	<TR>
		<TD align="right" width="164" height="51">
			<A href="javascript:voltaPrincipal(document.frm1);" class="cbutton">VOLTAR</A>
		</TD>
		<TD class="boxTexto" align="center" width="266" height="51">
...
<script type="text/javascript">
  ...
  _gaq.push(['_trackPageview','/APP/CotacaoMulti/Div7103Cad.jsp']);
