...
<TABLE border="0" cellpadding="5" cellspacing="0" class="tabelaAction">
	<TBODY>
		<TR>
			<TD class="boxTitulo" width="394">Ramo 710 - Riscos Diversos -
			Portáteis</TD>
		</TR>
		<TR valign="top">
			<TD width="394" height="115">
				...
				<TBODY>
					...
					<TR>
						<TD class="boxTexto" height="18" colspan="2"><TEXTAREA onkeyup="javascript:maxCaracteres(document.frm1.DscEquip,495)"
							...
							style="color: #4686BE"><c:if test='${bean.dscEquip!=null}'> <c:out
								value='${bean.dscEquip}' />
						</c:if></TEXTAREA></TD>
						<TD class="boxTexto" height="22" width="1"></TD>
					</TR>
...
<TABLE>
	<TR>
		<TD align="right" height="46" width="161">
			<A href="javascript:voltaPrincipal(document.frm1);" class="cbutton">VOLTAR</A>
		</TD>
		<TD class="boxTexto" align="center" height="46" width="269">
...
<script type="text/javascript">
  ...
  _gaq.push(['_trackPageview','/APP/CotacaoMulti/Div7102Cad.jsp']);
