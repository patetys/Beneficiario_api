		...
		<TR valign="top">
			...
			<TABLE border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
				<TBODY>
					...
					<TR>
						<TD class="boxTexto" height="46" width="173">Utilização:</TD>
						<TD class="boxTexto" height="46" width="257">
						<TABLE border="0" cellpadding="0" cellspacing="0"
							bgcolor="#FFFFFF">
							<TBODY>
								<TR align="left">
									<TD class="boxTexto" align="left" width="70"><INPUT
										type="radio" name="TpUtiliza" value="1"
										<c:if test="${bean.tpUtiliza=='1' || bean.tpUtiliza==null }"> checked </c:if>>Interna</TD>
									<TD class="boxTexto" align="left" width="70"><INPUT
										type="radio" name="TpUtiliza" value="2"
										<c:if test="${bean.tpUtiliza=='2' }"> checked </c:if>>Externa</TD>
								</TR>
							</TBODY>
						</TABLE>
						<TD class="boxTexto" height="46" width="1"></TD>
					</TR>
					<TR>
						<TD class="boxTexto" width="173" height="34">Sinistralidade dos
						últimos 5 anos</TD>
						<TD class="boxTexto" width="257" height="34"><INPUT type="text"
						...
						<TD class="boxTexto" width="1" height="34"></TD>
					</TR>
				</TBODY>
			</TABLE>
			</TD>
...
<TABLE>
	<TR>
		<TD align="right" width="165" height="50">
			<A href="javascript:voltaPrincipal(document.frm1);" class="cbutton">VOLTAR</A>
		</TD>
		<TD class="boxTexto" align="center" width="265" height="50">
...
<script type="text/javascript">
  ...
  _gaq.push(['_trackPageview','/APP/CotacaoMulti/Div7109Cad.jsp']);
