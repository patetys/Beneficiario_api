...
<TABLE border="0" cellpadding="5" cellspacing="0" bgcolor="#8FBCE4"
	...
	<TBODY>
		<TR>
			<TD class="boxTitulo" height="9" width="392">Anexos</TD>
		</TR>
		<TR valign="top">
			<TD height="130" width="392">
			<TABLE border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"
				...
				<TBODY>
					...
					<TR>
						<TD class="boxTitulo" colspan="2" bgcolor="#8FBCE4" height="21">Anexos</TD>
						<TD class="boxTitulo" bgcolor="#8FBCE4" width="12" height="21"></TD>
					</TR>
					<TR>
					...
					<TR>
						<TD class="boxTitulo" colspan="2" bgcolor="#8FBCE4" height="6"></TD>
						<TD class="boxTitulo" bgcolor="#8FBCE4" width="12" height="6"></TD>
					</TR>
					<TR>
						<TD class="boxTexto" colspan="3" align="center" height="35"><INPUT
							type="image" name="btnEnviar" src="images/botaoEnviar.gif"
...
<script type="text/javascript">
  ...
  _gaq.push(['_trackPageview','/APP/CotacaoMulti/ArquivoAnexo.jsp']);
