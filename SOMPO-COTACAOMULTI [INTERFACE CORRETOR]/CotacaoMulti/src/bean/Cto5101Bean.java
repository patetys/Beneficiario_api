 ...
 *
 */
public class Cto5101Bean extends CotacaoBean {

	private static final long serialVersionUID = 9140333718154138174L;
	...
	private final String DIVCADJSP = "Div5101Cad.jsp"; // Pagina jsp
	...
	public void setDBtoBean(Hashtable d) {
		...
		setNumSin5anos((String) d.get("dados05"));
	...
	public void setDadosHtml() {
		...
		dados_html[2] = "Altura (M)";
		dados_html[3] = getAltura();

		dados_html[4] = "Área (M<FONT style='vertical-align: text-top;font-size: 6pt;'>2</FONT>)";
	...
	public void setDados(HttpServletRequest req) {
		...
		setAltura(req.getParameter("Altura"));

		setAreaM2(req.getParameter("AreaM2"));
